...
% Title.
% ------
\title{%Joint Learning Lung Nodules Analysis Based on 3D Convolutional Neural Network
Fine Grain Lung Nodule Diagnosis Based on CT using 3-D Convolutional Neural Network}
%
% Single address.
% ---------------
\name{Qiuli Wang, Jiajia Zhang, Sheng Huang, Feiyu Chen, Xiaohong Zhang, Dan Yang}
\address{School of Big Data \& Software Engineering, Chongqing University, Chongqing, 400000, China }
%
% For example:
% ------------
%\address{School\\
...
%It should be pointed out that the fake nodule samples are considered as the 'low risk' samples in the branch of MSE prediction for fully exploiting the training samples.
