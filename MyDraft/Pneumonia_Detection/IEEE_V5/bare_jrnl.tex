...
\begin{abstract}
    \emph{Objective:} Pneumonia detection is one of the most crucial steps in pneumonia diagdiagnosing system. Clinical information of patients plays an important role in detection of pneumonia. In this paper, a Multimodal Data Network(MDNet) is described for clinical pneumonia detection.
